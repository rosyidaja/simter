					...
					<div class="row-fluid">
						<form id="form-tambah-anakan" name="form-tambah-anakan" action="<?php ?>" method="POST" onsubmit="return validasi_input(this)">
								...
								<div class="row-fluid">
									...
									<div class="controls">
										<input type="text" name="nomor_ring" id="nomor_ring" value="<?php echo $anakan->nomor_ring; ?>" placeholder="Nomor Ring" maxlength="50" required/>
									</div>
								</div>
								<div class="row-fluid">
								...
								<div class="row-fluid">
													...
													<div class="control-group">
														<div class="row-fluid input-append">
															<input class="span10 date-picker" value="<?php echo date('d-m-Y', strtotime($anakan->tanggal_lahir)); ?>" name="date" id="id-date-picker-1" type="text" data-date-format="dd-mm-yyyy" />
															<span class="add-on">
...
<![endif]-->
		...
		$('#indukan').val("<?php echo $anakan->id_indukan; ?>");
		$('#status').val('<?php echo $anakan->status; ?>');
