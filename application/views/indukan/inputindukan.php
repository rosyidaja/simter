		...
		<div class="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main">
					<div class="row-fluid">
						<form id="form-tambah-anakan" name="form-tambah-anakan" action="<?php echo site_url('indukan/tambahData'); ?>" method="POST">
								<div class="row-fluid">
